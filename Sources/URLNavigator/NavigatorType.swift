...
public typealias ViewModelFactory<T> = (_ url: URLConvertible, _ values: [String: Any], _ context: Any?) -> T?

public typealias URLOpenHandlerFactory<T> = (_ viewModel: T, _ url: URLConvertible, _ values: [String: Any], _ context: Any?) -> Bool
...
public protocol NavigatorType {
  ...
  var delegate: NavigatorDelegate? { get set }
    ...
    func addRoute(_ pattern: URLPattern, viewModelFactory: @escaping ViewModelFactory, handlerFactory: URLOpenHandlerFactory?)
 ...
 // func register(_ pattern: URLPattern, _ factory: @escaping ViewControllerFactory)
  ...
  //func register(_ pattern: URLPattern, _ factory: @escaping ViewModelFactory)
